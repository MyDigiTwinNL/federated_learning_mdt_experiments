...
for i in range(10):
    ...
    print (nn_true_df)
    print("Merged DataFrame shape:", nn_true_df.shape)
    print(nn_true_df.head())
    ...
    sns.scatterplot(x="time", y="normalized_output", data=merged_df)
    ...
    plt.savefig(os.path.join(csv_folder, 'calib_plot_full_fold_%s.png' %i), bbox_inches='tight', dpi=300)
    plt.savefig(os.path.join(csv_folder, 'calib_plot_full_fold_%s.eps' %i), bbox_inches='tight', dpi=300)
    plt.close()

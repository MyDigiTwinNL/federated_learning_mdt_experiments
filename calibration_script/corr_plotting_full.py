...
plt.savefig(os.path.join(csv_folder, 'calib_plot_full.png' ), bbox_inches='tight', dpi=300)
plt.savefig(os.path.join(csv_folder, 'calib_plot_full.eps' ), bbox_inches='tight', dpi=300)
plt.close()
